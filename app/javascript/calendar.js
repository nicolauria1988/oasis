  ...
  dates.forEach((date) => {
    date.addEventListener("click", function (e) {
      ...
      datesObj.forEach((date) => {
        ...
        if (
          selectedDateObj > new Date(date.startDate) &&
          selectedDateObj < new Date(date.endDate)
        ) {
          checkDates = false;
          return;
        }
      ...
      if (checkDates == false) return;

      if (startDate == null) {
        startDate = selectedDate;
        startTd = e.target;
        startTd.style.backgroundColor = "#e8f0fe";
      } else {
        ...
        endTd.style.backgroundColor = "#fff";
        startTd = null;
        endTd = null;
        startDate = null;
        endDate = null;
